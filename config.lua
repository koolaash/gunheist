...
-- Gun_client config
Config.hackingPosition = vector3(-1056.59, -232.38, 44.96) -- Where the computer hacking will
...
Config.hackScript = "mhacking" -- put the name of hacking you are using in your server
Config.requiredPolice = 1 -- how many active police required to trigger the gun hesit
...
Config.gamePassword = "DNDHEIST" --You could make a table with passwords and assign them as passwords in random order.
Config.lives = 2 -- how many tries you have in hack
Config.hud = '5G-Hud' -- the hud you are using

-- gun_server config
Config.dropItems =  { 
    -- you can add many as you want to but in the same format
	...
	{itemName = "WEAPON_FNX45", label = "FNX45 Pistol", chance = 40},
}
